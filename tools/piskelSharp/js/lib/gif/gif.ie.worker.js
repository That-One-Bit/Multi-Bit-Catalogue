(function (b) {
  ...
  a.modules = {}, a.cache = {}, a.resolve = function (b) {
    ...
    c.prototype.newPage = function () {
      ...
      for (var a = 0; a < j;) {
        var f = k - (this.colorTab[a++] & 255),
          ...
          i = f * f + g * g + h * h,
          b = parseInt(a / 3);
        (this.preserveColors || this.usedEntry[b]) && i < d && (d = i, c = b), a++;
      }
      return c;
    ...
    function c(c, d, b) {
      this.pixels = c, this.palette = [], this.paletteIndex = {}, this.getColormap = function () {
        return this.palette;
        ...
        var b = a(c, d, e);
        this.paletteIndex.hasOwnProperty(b) || (this.palette.push(c), this.palette.push(d), this.palette.push(e), this.paletteIndex[b] = this.palette.length / 3 - 1);
